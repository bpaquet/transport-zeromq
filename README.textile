...
<pre>
$ bin\plugin -install bpaquet/transport-zeromq/0.0.5
</pre>

Elasticsearch automatically install the plugin:

<pre>
-> Installing bpaquet/transport-zeromq/0.0.5...
Trying https://github.com/downloads/bpaquet/transport-zeromq/0.0.5.zip...
Downloading ..........DONE
